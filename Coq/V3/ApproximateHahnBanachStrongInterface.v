(** ApproximateHahnBanachStrongInterface.v -- authoritative Lemma 3.1 contract with literal computability.

    The output carries a rational Type-2 realizer on fast source names. Any
    future CHECKED-EXACT claim for Lemma 3.1 must construct this record uniformly
    from the computable Banach presentation, nonzero computable vector and
    rational eta. No exact norm-preserving Hahn--Banach selector is postulated.
*)
