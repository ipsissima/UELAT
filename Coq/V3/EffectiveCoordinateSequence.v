(** EffectiveCoordinateSequence.v -- effective ambient Hilbert-cube
    coordinates versus admissible dual-ball points. *)

From Coq Require Import Reals QArith Qreals.
From UELAT.V3 Require Import
  RepresentedSpace ComputableBanach
...
Section EffectiveSequences.
  ...
  Definition EffectiveCoordinateBallPoint :=
    { a : EffectiveCoordinateSequence |
      CoordinateAdmissible B (ecs_values a) }.
  ...
  Theorem effective_ball_approx_sound : forall a i n,
    Rabs
      (Q2R (effective_ball_approx a i n)
       - cdb_coordinates (effective_ball_coordinate_point a) i)
      <= dyadic n.
  Proof.
    intros a i n.
    unfold effective_ball_approx, effective_ball_coordinate_point.
