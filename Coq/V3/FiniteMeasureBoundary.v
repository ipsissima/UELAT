(** FiniteMeasureBoundary.v -- authoritative Corollary 8.6.

    The result is internal to the CCP-generated universe. Starting from
    finite-measure primitives and finite-measure-preserving constructors, a
    finite equidecomposition by admitted measure-preserving motions cannot
    duplicate a positive finite-measure object. Classical Banach--Tarski is
    untouched because its nonmeasurable pieces lie outside this generated class.
*)
...
Section AlgebraicDuplication.
  ...
  Proof.
    ...
    rewrite finite_partition_additivity in duplication_additivity. lra.
  Qed.
...
Section GeneratedFiniteMeasureBoundary.
  ...
  Proof.
    ...
    rewrite Hiso in Hdup. rewrite Hpart in Hdup. lra.
  Qed.
