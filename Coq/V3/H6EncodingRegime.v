(** H6EncodingRegime.v -- two-sided finite-encoding part of authoritative H6.

    Same-order comparison needs M_n beta_n <= const*B_n; the standard rational
    corollary also uses B_n <= const*M_n beta_n. H1H7Data carries the former;
    this extension records the latter.
*)
