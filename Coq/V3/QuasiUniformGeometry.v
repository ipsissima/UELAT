(** QuasiUniformGeometry.v -- H1 geometric summability for authoritative v3 Theorem 7.4.

    Manuscript H1 gives rational constants c_M,C_M with
      c_M h_n^{-1} <= M_n <= C_M h_n^{-1}, h_n = h_0 2^{-n}.
    After absorbing h_0 and clearing denominators this yields the natural
    inequalities below. The main theorem proves the geometric summability used
    by Theorem 7.4.
*)
...
Section Geometry.
  ...
  Hypothesis C_num_pos : 0 < C_num.
  Hypothesis C_den_pos : 0 < C_den.
  Hypothesis quasi_lower : forall n, c_num * pow2 n <= c_den * M n.
  Hypothesis quasi_upper : forall n, C_den * M n <= C_num * pow2 n.
