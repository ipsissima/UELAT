...
Fixpoint inner_piece_against_list (u : RationalPiece) (ys : list RationalPiece) : Q :=
  match ys with | [] => 0 | v :: rest => pair_w12_inner u v + inner_piece_against_list u rest end.
...
Theorem pair_overlap_endpoints_are_rational : forall u v,
  exists a b : Q, a = overlap_left u v /\ b = overlap_right u v.
Proof. intros. repeat eexists; reflexivity. Qed.
