(** RationalIntervalCover.v -- finite search layer for authoritative Lemma 5.4.

    Once a rational subdivision is fine enough that every closed vertex star is
    contained in some cover interval, the required assignment is a finite
    decidable search. This module implements that search and proves
