(** RationalSobolevCompleteness.v -- semantic existence part of authoritative Proposition 5.3.

    Given a true strict metric bound, dyadic tails eventually fit inside the
    slack. Exact rational finite-stage squared distances then produce the
...
Section ApproximationCompleteness.
  ...
  Proof.
    ...
    exists (PositiveApprox n sigma). simpl. repeat split.
...
Section DistanceCompleteness.
  ...
  Proof.
    ...
    exists (PositiveDistance n sigma). simpl. repeat split.
    - unfold dtrue in Hsmall. lra.
    - reflexivity.
