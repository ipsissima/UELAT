(** RationalSobolevPresentation.v -- authoritative Definition 5.1.

    Connects the rational piecewise-polynomial finite language to a represented
    W^{1,2} carrier with exact finite-stage squared distances, fast-Cauchy code
    names, exact constant names, and the manuscript's approximation/distance
    witness grammar.
*)
...
Definition approx_accept
  ...
  match w with
  | ExactSelf p0 => p0 = p /\ nu = w12_constant_name p /\ q = 0
...
Proof. intros P p. simpl. repeat split; reflexivity. Qed.
