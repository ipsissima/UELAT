(** RationalSynthesis.v -- authoritative v3 Proposition 5.5.

    On the rational piecewise-polynomial code language, synthesis is an exact
    finite fold of multiplication by partition codes followed by addition. This
    module proves the semantic fold equation and the corresponding finite
    structural evidence compilation theorem.
*)
