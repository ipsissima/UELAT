(** RefinementGenealogyCompiler.v -- concrete H5 persistence across levels.
    ...
    Histories are built append-only from one base leaf and a finite list of new
    proof steps per refinement level. The previous history is literally a prefix
    of the next, so retained ancestry is shared rather than copied.
*)
...
Section Compiler.
  ...
  Proof. intro n. simpl. apply compile_refinement_level_shares_old_history. Qed.
