(** RepresentedSpace.v -- fast Cauchy representation core for v3 Section 2.
    ...
    It deliberately separates that mathematical representation from the later
    computability layer: a future ComputableBanach module must add effective
    enumeration of the rational core and Type-2 realizers.  Hence the ledger
    marks Definition 2.1 PARTIAL rather than MATCHED.
*)
