(** ScaleSensitivePUFEMAnalytic.v -- standard analytic derivation for authoritative Theorem 7.2.

    Local order-r approximation gives aggregate L2 and derivative errors;
    bounded overlap controls global sums; the partition derivative costs one
    inverse power of h; and the W12 norm is bounded by the two components.
    The final C_* is derived rather than assumed.
*)
...
Section ClassicalRate.
  ...
  Proof.
    ...
    pose proof (local_l2_rate D) as Hl.
    nra.
  Qed.
  ...
  Proof.
    ...
    pose proof (local_deriv_rate D) as Hl1.
    nra.
  Qed.
