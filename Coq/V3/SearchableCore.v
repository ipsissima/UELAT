(** SearchableCore.v -- executable indexing of the rational core for authoritative Section 3.

    Effective algorithms need to recover an enumeration index for supplied
    finite core syntax. Decidable equality plus the surjective core enumeration
    gives a terminating constructive search.
*)
...
Proof.
  intros B p.
  destruct (core_enum_surjective (sc_banach B) p) as [n Hn].
