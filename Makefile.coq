...
Makefile.coq.conf: Coq/_CoqProject
	coq_makefile -f Coq/_CoqProject -o Makefile.coq
...
VDFILE_FLAGS:=$(if Coq/_CoqProject,-f Coq/_CoqProject,) $(CMDLINE_COQLIBS) $(CMDLINE_VFILES)

$(VDFILE): Coq/_CoqProject $(VFILES)
	$(SHOW)'COQDEP VFILES'
